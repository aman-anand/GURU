            ...
            <Link to="/sessions" className={`${['/sessions'].includes(pathname) ? 'active' : null}`} role="presentation">
              <i className="icon">
                <svg width="14" height="16" viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M0 16V4.8H3.11111V16H0ZM5.44444 16V0H8.55556V16H5.44444ZM10.8889 16V9.6H14V16H10.8889Z" fill="#403F3F" />
                </svg>
              </i>
            ...
            <Link to="/sessions" className={`${['/sessions'].includes(pathname) ? 'active' : null}`} role="presentation">
              <i className="icon">
                <svg width="24" height="15" viewBox="0 0 24 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M11 4V0L18 7L11 14V9.9C6 9.9 2.5 11.5 0 15C1 10 4 5 11 4ZM17 3V0L24 7L17 14V11L21 7L17 3Z" fill="#403F3F" />
                </svg>
              </i>
